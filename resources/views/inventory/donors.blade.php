            ...
            <div class="row mx-0">
                ...
                <div class="col-12 d-flex align-items-center gap-2 mb-2">
                    ...
                    <button type="button" class="btn btn-secondary text-nowrap" data-bs-toggle="modal"
                            data-bs-target="#donorModal">New Donor
                    </button>
                ...
                <table class="table table-hover table-bordered">
                    ...
                    @foreach($donors as $donor)
                        <tr>
                            ...
                            <td>
                                <div class="badge pill-{{$donor->status}}">{{$donor->status}}</div>
                            </td>
                            <td>
                                <div class="d-flex gap-2 align-items-center flex-nowrap">

                                    <a class="btn btn-secondary" type="button" href="/inventory/donors/{{$donor->id}}">
                                        edit
                                    </a>

                                    <form data-confirmation="Are you sure you want to delete this donor?"
                                        class="confirmation" method="POST" action="{{ route('donor.delete', $donor->id) }}">
                                    @csrf
                                    @method('DELETE')
            ...
            <div class="modal-content">
                <form enctype="multipart/form-data" class="w-full" method="POST" action="/donor">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">New Donor</h5>
